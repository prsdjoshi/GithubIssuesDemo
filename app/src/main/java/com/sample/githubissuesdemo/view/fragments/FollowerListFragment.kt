...
import com.sample.githubissuesdemo.databinding.FragmentFollowerListBinding
import com.sample.githubissuesdemo.databinding.LoadingStateConfigBinding
import com.sample.githubissuesdemo.view.adapters.FollowerListAdapter
...
class FollowerListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_follower_list, container, false)
    ...
    private fun initRecyclerView() {
        with(binding.recyclerView) {
            ...
            val issueRecyclerViewAdapter = FollowerListAdapter {
            }
